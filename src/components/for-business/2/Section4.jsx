  ...
  return (
    <Stack
      sx={{
        ...
        alignItems: 'start',
        gap: '15px',
        margin: { xs: '40px 30px', md: '100px 101px 80px' },
    ...
    >
      ...
      >
        <Typography sx={{ fontSize: '18px', color: '#fff' }}>
          Aligning organizations with top-tier professionals for success.
        </Typography>
        <Typography sx={{ fontWeight: 700, fontSize: '35px', color: '#fff' }}>
          We help companies to save recruitment cost up to 58% with our machine
          learning powered platform.
        </Typography>
      </Stack>
      {/* <Button
        href="/sign-up"
