...
const Navbar = () => {
  ...
  const drawerContent = (
    ...
    >
      ...
      <Button sx={{ ...BlackBtnStyle, color: activeBusiness ? '#01B1A8' : '#1F1D1D' }}>For Business</Button>
      <Button sx={{ ...BlackBtnStyle, color: activeTalent ? '#01B1A8' : '#1F1D1D' }}>For Talent</Button>
      <Button sx={{ ...BlackBtnStyle, color: activeWhy ? '#01B1A8' : '#1F1D1D' }}>Why Solvnex</Button>
      <Button sx={{ ...BlackBtnStyle, color: activeCareer ? '#01B1A8' : '#1F1D1D' }}>Career Guides</Button>
      <Button sx={{ ...BlackBtnStyle, color: activeArticles ? '#01B1A8' : '#1F1D1D' }}>Articles</Button>
      <Button sx={{ ...BlackBtnStyle, color: activeFaq ? '#01B1A8' : '#1F1D1D' }}>FAQ</Button>
  ...
  return (
    ...
    >
      ...
      >
        <Button
          onClick={(event) =>
            handleMenuOpen(event, setBusinessMenu)
          }
          sx={{ ...BlackBtnStyle, color: activeBusiness ? '#01B1A8' : '#1F1D1D' }}
        >
          For Business
        </Button>
        <NavbarMenu
        ...
        />
        <Button href="/why-solvnex" sx={{ ...BlackBtnStyle, color: activeWhy ? '#01B1A8' : '#1F1D1D' }}>
          Why Solvnex
        </Button>
        <Button
        ...
        />
        <Button href="/articles" sx={{ ...BlackBtnStyle, color: activeArticles ? '#01B1A8' : '#1F1D1D' }}>
          Articles
        </Button>
        <Button href="/faq/page-1" sx={{ ...BlackBtnStyle, color: activeFaq ? '#01B1A8' : '#1F1D1D' }}>
          FAQ
        </Button>
